...
int freqs [] = { 
	913100000, 									// Channel 0, 913.1 
	913300000, 									// Channel 1, 913.3 
	913500000, 									// Channel 2, 913.5 
	913700000, 									// Channel 3, 913.7 
	913900000,                  //...
	914100000, 
	914300000, 
	914500000, 
  ...
  // http://www.rfwireless-world.com/Tutorials/LoRa-frequency-bands.html
};
uint32_t  freq = freqs[9];
uint8_t	 ifreq = 9;								// Channel Index
...
#elif _PIN_OUT==2//                        ESP8266 PINOUT
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
// For ComResult gateway PCB use the following settings
struct pins {
	uint8_t dio0=5;		// GPIO5 
	uint8_t dio1=4;		// GPIO4 
	uint8_t dio2=2;		// GPIO0 
	uint8_t ss=15;		// GPIO15 
	uint8_t rst=16;		// GPIO16 

  //#define SCK     14    // GPIO14
  //#define MISO    12   // GPIO12
  //#define MOSI    13   // GPIO13
  //#define SS      15   // GPIO15
  //#define RST     16   // GPIO16
  //#define DI00    5   // GPIO5

} pins;//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
#elif _PIN_OUT==3 //                      ESP32 PINOUT
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
struct pins {
  uint8_t dio0=17;   // GPIO17 / D1. Dio0 used for one frequency and one SF
  uint8_t dio1=18;   // GPIO18 / D2. Used for CAD, may or not be shared with DIO0
  uint8_t dio2=4;   // GPIO4 / D3. Used for frequency hopping, don't care
  uint8_t ss=5;    // GPIO5 / D8. Select pin connected to GPIO15
  uint8_t rst=22;    // GPIO22 / D3. Reset pin not used 
...
#define RST     22   // GPIO22 -- SX127x's RESET
#define DI00    17   // GPIO17 -- SX127x's IRQ(Interrupt Request)  
} pins;
#else
